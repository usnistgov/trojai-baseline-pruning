...
# it was created for round 2 TrojAI challenge
"""
...
def graph_extractor(model_dirpath, result_filepath, scratch_dirpath, model_format='.pt'):
...
if __name__ == "__main__":
    ...
    graph_extractor(args.model_dirpath,  args.result_filepath, args.scratch_dirpath, args.model_format)
