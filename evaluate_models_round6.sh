...
MODEL_DIR=/home/pnb/raid1/trojai/datasets/round6/round6-train-dataset/models
#MODEL_DIR=/wrk/pnb/trojai_data/round6/round6-train-dataset
#MODEL_DIR=/mnt/extra-data/data/round6-train-dataset/models
EMBEDDING_DIRPATH=/home/pnb/raid1/trojai/datasets/round6/round6-train-dataset/embeddings
TOKENIZER_DIRPATH=/home/pnb/raid1/trojai/datasets/round6/round6-train-dataset/tokenizers
...
#RESULT_DIR=/wrk/pnb/trojai_data/round6/scratch_r6
#SCRATCH_DIR=/wrk/pnb/trojai_data/round6/scratch_r6
#RESULT_DIR=/home/jameshobbs/scratch-r6
#SCRATCH_DIR=/home/jameshobbs/scratch-r6
...
do
	...
	if [ "$dir" != "$MODEL_DIR" ]; then
		...
		if [[ $MODEL == id* ]] ; then
			...
			python ./trojan_detector_nlp.py --my-config ./config_files/round6.config --model_filepath $dir/model.pt  --result_filepath $RESULT_DIR/test_python_output.txt --scratch_dirpath $SCRATCH_DIR --examples_dirpath $dir/clean_example_data --embedding_dirpath $EMBEDDING_DIRPATH --tokenizer_dirpath $TOKENIZER_DIRPATH
