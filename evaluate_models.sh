...
MODEL_DIR=/home/pnb/raid1/trojai/datasets/round1/round1-train-dataset


#ACTIVE_DIR=/home/trojai/active

#CONTAINER_EXEC=/mnt/scratch/$CONTAINER_NAME
RESULT_DIR=/home/pnb/raid1/trojai/datasets/round1/scratch
SCRATCH_DIR=/home/pnb/raid1/trojai/datasets/round1/scratch
...
do
	...
	if [ "$dir" != "$MODEL_DIR" ]; then
		...
		if [[ $MODEL == id* ]] ; then
			...
			python ./trojan_detector.py --model_filepath $dir/model.pt  --result_filepath $RESULT_DIR/test_python_output.txt --scratch_dirpath $SCRATCH_DIR --examples_dirpath $dir/example_data
