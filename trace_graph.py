...
"""
This class is used for extracting a graph from a loaded AI model
This code was adopted from https://discuss.pytorch.org/t/print-autograd-graph/692
"""
...
if __name__ == '__main__':
    ...
    print('dot source:', dot.source)

    G = nx.DiGraph(day="Friday")
    print('G.graph:', G.graph)

    #dot.view()
    # for n, nbrsdict in dot.adjacency():
    #
    #     for nbr, eattr in nbrsdict.items():
    #         print(' nbr:', nbr)
    #         if 'weight' in eattr:
    #             # Do something useful with the edges
    #             print('weight eattr:', eattr)
    #             pass



    # for node in dot._node:
    #
    #     my_name = node.name
    #     my_input = node.inputs()
    #
    #     print('node:', my_name, ', input:', my_input)


    # this works only for onnyx
